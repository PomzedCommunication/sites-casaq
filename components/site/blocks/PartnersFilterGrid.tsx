                                        ...
                                        <a href={`mailto:${partner.email}`} aria-label="Email">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                ...
                                                <g clipPath="url(#clip0_365_608)">
                                                    <path
                                                        d="M2.33301 17.5C1.81738 17.5 1.37613 17.3166 1.00926 16.9497C0.642383 16.5828 0.458633 16.1412 0.458008 15.625V4.375C0.458008 3.85937 0.641758 3.41812 1.00926 3.05125C1.37676 2.68437 1.81801 2.50062 2.33301 2.5H17.333C17.8486 2.5 18.2902 2.68375 18.6577 3.05125C19.0252 3.41875 19.2086 3.86 19.208 4.375V15.625C19.208 16.1406 19.0246 16.5822 18.6577 16.9497C18.2908 17.3172 17.8493 17.5006 17.333 17.5H2.33301ZM9.83301 10.9375L17.333 6.25V4.375L9.83301 9.0625L2.33301 4.375V6.25L9.83301 10.9375Z"
                                                        fill="white"/>
                                                </g>
                                                <defs>
                                    ...
                                    {partner.phone ? (
                                        <a href={`tel:${partner.phone.replace(/[^\d+]/g, '')}`} aria-label="Téléphone">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M3.85523 8.65556C5.45523 11.8 8.03301 14.3667 11.1775 15.9778L13.6219 13.5333C13.9219 13.2333 14.3663 13.1333 14.7552 13.2667C15.9997 13.6778 17.3441 13.9 18.7219 13.9C19.333 13.9 19.833 14.4 19.833 15.0111V18.8889C19.833 19.5 19.333 20 18.7219 20C8.28856 20 -0.166992 11.5444 -0.166992 1.11111C-0.166992 0.5 0.333008 0 0.944119 0H4.83301C5.44412 0 5.94412 0.5 5.94412 1.11111C5.94412 2.5 6.16634 3.83333 6.57745 5.07778C6.69967 5.46667 6.61079 5.9 6.29967 6.21111L3.85523 8.65556Z"
                                                    fill="white"/>
                                            </svg>
