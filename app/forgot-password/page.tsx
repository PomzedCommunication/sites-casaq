...
import { ForgotPasswordFormClient } from '@/components/site/account/ForgotPasswordFormClient';
...
export async function generateMetadata({
    ...
    return {
        title: site ? `Mot de passe oublié — ${site.agence.nom}` : 'Mot de passe oublié',
    ...
    return (
        ...
        >
            <main className="account-auth">
                <ForgotPasswordFormClient previewDomain={resolvedSearchParams?.site} />
            </main>
        </SiteLayout>
    );
}